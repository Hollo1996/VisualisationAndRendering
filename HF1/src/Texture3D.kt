...
private val GL.Companion.RED: Int
    get() = 0x1903

private val GL.Companion.R8: Int
    get() = 0x8229
    ...
    init {
        ...
        image.onload = {
            ...
            for (i: Int in 0..255)
                for (j: Int in 0..255)
                    for (k: Int in 0..255) {
                        var v : Byte = imageData.data[(i + 4096 * (256-j) + 256 * (k % 16) + 4096 * 256 * kotlin.math.floor(x = k / 16.0f).toInt()) * 4]
